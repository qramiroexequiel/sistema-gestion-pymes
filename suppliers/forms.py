"""
Formularios del módulo suppliers.
"""
...
class SupplierForm(forms.ModelForm):
    ...
    def clean_code(self):
        ...
        if self.company:
            ...
            if queryset.exists():
                raise forms.ValidationError(f'Ya existe un proveedor con el código "{code}" en esta empresa.')
        
        return code
    
    def save(self, commit=True):
        """Guardar el proveedor asociándolo a la empresa actual."""
